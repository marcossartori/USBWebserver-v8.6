...
?>
<table cellspacing="1" style="width:720; text-align:center; border:0; font-size:13px; background-color:#FFF">
...
?>
 ...
 <b><?php include('..\..\sistema\validacao\menu\contratos\menu_contratos_cabecalho.php');?></b>
          	...
          	<table align="center"cellspacing="1" style="width:720; text-align:center; border:0; font-size:13px; background-color:#FFF">
...
while ($linha = mysql_fetch_object($sql)) {
			...
			echo "<a href='"; 
			echo "../../sistema/MAPA/visualizar_edit_mapa_bolsista_estagiarios.php?id=";
			echo $linha->id;
			echo "'>";
