...
<form id="form2" name="form2" method="post" action="processa_edicao2_contrato_mapa_bolsista_estagiarios.php">
...
<tr>
 		...
 		<td colspan="2" style="height:25;"><blockquote>
 		  <p><b>Possivel Vigência:</b>
 		    ...
 		    <?php echo $dado_adm['vigencia'];?>  <b><?php  $fim = somar_data($dado_adm['vigencia'], 0, 0, 5); ?></b>
 		    </p>
	    </blockquote></td>
</tr>
