...
echo '<table border="0" align="center" cellspacing="0" class="alt" id="mytable" summary="The technical specifications of the Apple PowerMac G5 series";>';
  echo'<caption>&nbsp;</caption>';
	...
	echo' <th id="th" scope="col" abbr="Dual 1.8">'; echo 'CONTRATO';  echo'</th>';
	 echo' <th id="th" scope="col" abbr="Dual 1.8">'; echo 'ANO';  echo'</th>';
	  ...
	  echo'<th id="th" scope="col" abbr="Dual 1.8" >'; echo 'ATIVAR'; echo'</th>';
	echo '</tr>';
		...
		$sql = "SELECT * from documentos where ativo='N' ";
		if( sizeof( $and ) )
  ...
  echo '<tr>';
    ...
    echo '<td id="td">'; 	if ($ativo== "N"){
				
				 $status= ' ';
echo ' <IMG SRC="../../sistema/documentos/images/excluir.gif" WIDTH="20" HEIGHT="20" alt="NOME"/>';  
				
				} else{ echo $status= '<img  class="dcontexto" src="../../sistema/documentos/images/certo.png" WIDTH="20" HEIGHT="20"/>';}
	  ...
	  echo'</td>';
       ...
       echo '<td id="td">'; echo "<a  href='http:../../sistema/documentos/delete_arquivo.php?codarq=".$codigo."')'>"; echo '<IMG SRC="../../sistema/documentos/images/ativar.png" WIDTH="20" HEIGHT="20"  border="0"/>'; echo'</td>';
       echo"</tr>";
	}
	  echo'<tr>';
