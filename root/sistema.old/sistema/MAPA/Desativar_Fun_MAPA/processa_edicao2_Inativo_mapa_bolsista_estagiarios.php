	...
	if ($objetoConexao->estaComBancoSelecionado()==false) 
		...
		switch (get_post_action('inserir', 'atualizar', 'deletar')) 
			...
			case 'inserir':
							...
							$sql="INSERT INTO desativa_func SET usuario='{$_SESSION['nome']}',Data='$Data',data_saida='$data_saida',Hora='$Hora',descricao2='$descricao2',nome_funcionario='{$_SESSION['nome_funcionario']}'";
