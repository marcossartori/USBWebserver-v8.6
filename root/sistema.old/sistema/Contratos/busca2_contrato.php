...
$final_query  = "FROM contratos where Ativo = 'Sim' and ('{$_SESSION['nome']}' = fiscal_sub_1 OR '{$_SESSION['nome']}' = fiscal_sub_2 OR '{$_SESSION['nome']}' = fiscal_sub_3 OR '{$_SESSION['nome']}' = fiscal_sub_4 OR '{$_SESSION['nome']}'= fiscal)
...
while ($linha = mysql_fetch_object($sql)) {
			...
			echo "<a href='"; 
			echo "http://localhost/sistema/Contratos/visualizar_edit_contrato.php?id=";
			echo $linha->id;
			echo "'>";
