	...
	if ($objetoConexao->estaComBancoSelecionado()==false) 
		...
		switch (get_post_action('inserir', 'atualizar', 'deletar')) 
			...
			case 'inserir':
			                ...
			                $sql="UPDATE funcionarios SET Ativo='$Ativo',n_contrato ='$n_contrato',unidade='$unidade' WHERE nome_funcionario='{$_SESSION['nome_funcionario']}' = nome_funcionario='{$_SESSION['nome_funcionario']}'";
