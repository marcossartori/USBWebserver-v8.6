...
<form id="form1" name="form1" method="post" action="processa_edicao2_aditivo_02.php">
  ...
  <tr>
    <td colspan="2" style="text-align:center;
                               ...
                               <input name="renovacao_02" type="hidden" class="input-p" id="renovacao_02" size="25"  readonly="readonly" 
style="color: #999; background: #CCC;" value="<?php echo  $_SESSION['renovacao_02']; ?>" input></td>  
