...
<form id="form1" name="form1" method="post" action="processa_edicao2_aditivo.php">
  ...
  <tr>
    <td colspan="2" style="text-align:center;
            						...
            						">
                                    <p>Confirmar Renovação 01: <b><?php echo $_SESSION['renovacao_01'];?></b> </p>
                                   <p>&nbsp;</p></td></tr>
                               ...
                               <input name="renovacao_01" type="hidden" class="input-p" id="renovacao_01" size="25"  readonly="readonly" 
style="color: #999; background: #CCC;" value="<?php echo  $_SESSION['renovacao_01']; ?>" input></td>     
...
//echo utf8_encode($nome);?>" input></td>
  ...
  <p class="style1" align="center">
    <input type="submit" name="inserir" id="inserir" value="Gravar" onClick="return confirm('Deseja confirmar a renovação 01 do contrato ?')"  style="text-decoration:none"/> <input type="button" name="cancelar"  value="cancelar"  onclick="window.history.go(-1)">
  </p>
  <br />
