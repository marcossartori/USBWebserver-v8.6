...
style="color: #999; background: #CCC;" value="<?php echo $nome;
//echo utf8_encode($nome);?>" input></td>
  ...
  <p class="style1" align="center">
    <input type="submit" name="inserir" id="inserir" value="Gravar"/> <input type="button" name="cancelar"  value="cancelar"  onclick="window.history.go(-1)">
  </p>
  <br />
