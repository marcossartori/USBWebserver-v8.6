...
nome_funcionario='$nome_funcionario',telefone='$telefone',unidade='$unidade',cargo='$cargo',bolsista='$bolsista',endereco='$endereco',escolaridade='$escolaridade',sexo='$sexo',filhos='$filhos',Complemento='$Complemento',cargo_chefia='$cargo_chefia',email='$email',Numero='$Numero',Bairro='$Bairro',Cidade='$Cidade',Estado='$Estado',Ativo='$Ativo',n_contrato='$n_contrato',formacao='$formacao',tipo_contrato='$tipo_contrato',data_nasc='$data_nasc'";
...
nome_funcionario='$nome_funcionario',empresa='$empresa',telefone='$telefone',unidade='$unidade',cargo='$cargo',bolsista='$bolsista',endereco='$endereco',escolaridade='$escolaridade',sexo='$sexo',filhos='$filhos',Complemento='$Complemento',cargo_chefia='$cargo_chefia',email='$email',Numero='$Numero',Bairro='$Bairro',Cidade='$Cidade',Estado='$Estado',n_contrato='$n_contrato',formacao='$formacao',n_contrato='$n_contrato',data_nasc='$data_nasc' WHERE id=$id";
