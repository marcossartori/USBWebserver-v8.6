            <tr>
      <th width="226" align="right" scope="row" >Cargos</th>
				...
				<td><select id="cargo" name="cargo">
					...
					<?php
						$sql = "SELECT cargo FROM tab_cargo WHERE cargo <> 'null' and vinculo <> 'Mapa' and vinculo <> 'Estagiarios' and vinculo <> 'Bolsistas' ORDER BY cargo ASC";
