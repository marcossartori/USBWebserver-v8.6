...
if ($objetoConexao->estaConectado() == false){
	...
	if ($objetoConexao->estaComBancoSelecionado()==false) {
		echo "nao consegui selecionar o banco de ";
			...
			$idGet = $_GET['id'];
		$sql = "SELECT * FROM contratos, renovacao WHERE renovacao.n_contrato = contratos.n_contrato AND contratos.id = $idGet";
...
<form id="form2" name="form2" method="post" action="processa_edicao2_aditivo.php">
   <center>
