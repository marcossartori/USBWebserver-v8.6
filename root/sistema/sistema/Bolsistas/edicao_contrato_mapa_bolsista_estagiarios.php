...
<form id="form1" name="form1" method="post" action="processa_edicao2_contrato_mapa_bolsista_estagiarios.php">
  ...
  <table width="555" border="0" align="center">
    ...
    <tr>
      ...
      <input name="n_processo" type="text" id="n_processo" value="<?php echo $dado_adm['n_processo'];?>" readonly="readonly" /></td>
    </tr>
...
<?php
    ...
    <tr>
      ...
      <input name="valor_mensal" type="text" id="valor_mensal" value="<?php echo $dado_adm['valor_mensal'];?>" />
       ...
       <tr>
     <th align="right" scope="row">Vigencia</span></div></th>
      <td>

        <label for="vigencia"></label>
        <input name="vigencia" type="Text" id="vigencia" maxlength="25" size="25"/>
        <img src="http://localhost/sistema/sample/images2/cal.gif" onclick="javascript:NewCssCal ('vigencia','ddMMyyyy')" style="cursor:pointer"/>
 </td>
