...
TableTools.BUTTONS = {
	...
	"copy": $.extend( {}, TableTools.buttonBase, {
		...
		"fnComplete": function(nButton, oConfig, flash, text) {
			var
				...
				plural = (len==1) ? "" : "s";
			this.fnInfo( '<h6>Copiando...</h6>'+
				'<p>Dados '+len+' row'+plural+' to the clipboard.</p>',
				1500
			);
		}
	} ),
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h6>Sistema de RH Lanagro RS</h6><p>Dados copiados com sucesso's print function to "+
		  "print this table. Press escape when finished.",
		"sMessage": null,
		"bShowAll": true,
		"sToolTip": "Dados copiados com sucesso",
