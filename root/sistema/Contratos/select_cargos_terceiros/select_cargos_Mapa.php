...
<th width="226" align="right" scope="row" >Cargo*</th>
                ...
                <option value="">Selecione
					...
					<?php
						$sql = "SELECT cargo,id FROM tab_cargo WHERE cargo <> 'null' and vinculo <> 'Terceirizados' and vinculo <> 'Estagiarios' and vinculo <> 'Bolsistas'  and n_contrato = '{$_SESSION['n_contrato']}' ORDER BY cargo ASC";
