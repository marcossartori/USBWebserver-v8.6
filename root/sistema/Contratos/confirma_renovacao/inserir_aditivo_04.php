...
<script language="JavaScript" type="text/javascript" src="../../../sistema/validacao/confirma_renovacao.js"></script>
...
<form id="form1" name="form1" method="post" action="processa_edicao2_aditivo_04.php">
  ...
  <tr>
    <td colspan="2" style="text-align:center;
            						...
            						">
                                    <p>Confirmar Renovação 04: <b><?php echo $_SESSION['renovacao_04'];?></b> </p>
                                   <p>&nbsp;</p></td></tr>
  
  
  

    									<?php $_SESSION['n_contrato'] ?>
                                    

                                    
                               <input name="renovacao_04" type="hidden" class="input-p" id="renovacao_04" size="25"  readonly="readonly" 
style="color: #999; background: #CCC;" value="<?php echo  $_SESSION['renovacao_04']; ?>" input></td>  
  
    
    <tr>

      <th width="209" align="right" class="style4" scope="row">Contrato</th>
      <td width="287" ><input name="n_contrato" type="text" disabled="disabled" class="input-p" id="n_contrato" onblur="ValidarContrato(form1.n_contrato);" onkeypress="MascaraContrato(form1.n_contrato);"  style="color: #999; background: #CCC;" value="<?php echo $dado_adm['n_contrato'];?>
...
echo $nome;
//echo utf8_encode($nome);?>" input></td>
  ...
  <p class="style1" align="center">
    <input type="submit" name="inserir" id="inserir" value="Gravar" onClick="return confirm('Deseja confirmar a renovação 04 do contrato ?')"  style="text-decoration:none"/> <input type="button" name="cancelar"  value="cancelar"  onclick="window.history.go(-1)">
  </p>
  <br />
