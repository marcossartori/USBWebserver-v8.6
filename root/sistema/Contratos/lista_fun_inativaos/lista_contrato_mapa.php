...
<select onchange="document.getElementById('n_contrato').value=this.value">
      <option value="">Selecione
					<?php
						$sql = "SELECT n_contrato, empresa FROM contratos WHERE n_contrato <> 'null' and tipo_contrato = 'Mapa' or n_contrato='Estagiarios' ORDER BY n_contrato ASC";
		  ...
		  <?php 
			...
			$linha_adm3 = "SELECT * FROM tab_empresa where id='$id'";
