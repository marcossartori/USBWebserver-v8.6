...
?>
          ...
          <a href="http:../../sistema/altera_senha.php" style="text-decoration:none">  Alterar Senha   |</a>
          <a href="http:../../sistema/Admin/Administrador.php?pagina=1" style="text-decoration:none">  Listar Usuarios   </a>
            ...
            <a href="http:../../sistema/validacao/filtros/extras/relatorios/relatorios_funcionarios.php" style="text-decoration:none"> | Consultas  </a>
         ...
         <tr style=" background-image:url(../../sistema/imagens/painel_pesquisa.jpg);
        			color:#FFF;
                    font-size:9px;">
    
    		<td colspan="2" style=" height:50;">
            
            <form action="../../sistema/Admin/pesquisa.php?pagina=0" method="GET">
  			<label>
...
while ($linha = mysql_fetch_object($sql)) {
			...
			echo "<a href='"; 
			echo "../../sistema/Admin/editar_adm.php?id_adm=";
			echo $linha->Id;
			...
			echo "<a href='"; 
			echo "../../sistema/Admin/remover_adm.php?id_adm="; 
			echo $linha->Id;
