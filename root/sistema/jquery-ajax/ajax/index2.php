...
<div id="mytabe">
	...
	<div id="header" style="overflow:auto" >
		...
		<table border="0" align="center" cellspacing="0" id="mytable"  >
        <tr>
			<th a scope="col" abbr="Dual 1.5"><a href="anexo.php" rel="ajax">ANO</a> </th>
			<th a scope="col" abbr="Dual 1.8"> <a href="http://localhost/jquery-ajax/ajax/anexo.php">Anexo</a></th> 
			<th a scope="col" abbr="Dual 1.8"><a href="#page3" rel="ajax">Documento</a></th>
			<th a scope="col" abbr="Dual 1.8"><a href="#page4" rel="ajax">hhh</a> </th>
